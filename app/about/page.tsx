...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'About Top Rated Chimney Services | Atlanta',
    description: 'Learn about our licensed and insured team dedicated to protecting Georgia homes.',
    url: 'https://topratedchimney.com/about/',
    siteName: 'Top Rated Chimney Services',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        url: 'https://topratedchimney.com/og-about.jpg',
        width: 1200,
        height: 630,
        alt: 'Top Rated Chimney Services team in Atlanta',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'About Our Chimney Service Team',
    description: 'Learn about our licensed and insured team dedicated to protecting Georgia homes.',
    images: ['https://topratedchimney.com/og-about.jpg'],
  },
};
